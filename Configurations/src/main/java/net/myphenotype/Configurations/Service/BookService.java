package net.myphenotype.Configurations.Service;

import lombok.extern.slf4j.Slf4j;
import net.myphenotype.Configurations.DAO.BookDao;
import net.myphenotype.Configurations.Entity.*;
...
public class  BookService {
    ...
    public void saveBook(BookExpanded bookExpanded) {
        ...
        if(bookExpanded.getId() != null)
            log.info("Book ID was not set to " + bookExpanded.getId());
