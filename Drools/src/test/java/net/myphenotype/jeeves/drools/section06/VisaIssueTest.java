...
import net.myphenotype.jeeves.drools.section08.FamilyVisaApplicationValidationTest;
...
class VisaIssueTest {
  ...
  void shouldExecuteAllSteps() {
    ...
    FamilyVisaApplicationValidationTest.emulateInputFromKeyboard("yes");
    VisaIssue.execute(5);
  ...
  void testStep5_noAnswer() {
    ...
    FamilyVisaApplicationValidationTest.emulateInputFromKeyboard("no");
    VisaIssue.execute(step);
