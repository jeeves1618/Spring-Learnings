...
public class StatefulInvoiceValidation {
  ...
  static void execute(int step) {
    ...
    KieSession ksession = kieClasspathContainer.newKieSession("StatefulInvoiceValidationStep" + step);
    ...
    invoices.forEach(invoice -> {
      System.out.println("This invoice " + invoice + " verdict: " + invoice.getValidation() + ", cause: " + invoice.getCause());
    });
  }
